...
5) Call the retrieve_statement_texts tool to download and extract the text from
   the statement and transcript PDFs using the URLs you found earlier.
   You should pass both the statement and transcript URLs from step 2 and 4,
   and retrieve the corresponding texts.
"""
